const Contact = () => {
  return (
    <section className={`relative w-screen flex justify-center`}>
                ...
                <div className="max-w-md mx-auto sm:max-w-lg lg:mx-0">
                  ...
                  >
                    ...
                    <div className="text-right sm:col-span-2">
                      <button
                        type="submit"
                        className="inline-flex justify-center py-2 px-4 border shadow-sm text-sm font-medium rounded-md text-slate-700 bg-grape-600 hover:bg-grape-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-grape-500"
                      >
                        Submit
                      </button>
                    </div>
